...
namespace BIA_Cinema_Ticket.Controllers
{
    public class MovieController : Controller
    {
        ...
        public static SqlConnection connection = new SqlConnection(@"Data Source=BEYZA;Initial Catalog=BIA;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        public List<Review> FetchComments(String commandText)
        {
            ...
            SqlConnection secondConnection = new SqlConnection(@"Data Source=BEYZA;Initial Catalog=BIA;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
